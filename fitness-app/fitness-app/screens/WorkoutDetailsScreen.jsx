        ...
        <View style={styles.body}>
          ...
          <View style={styles.stats}>
            <View style={styles.statBox}>
              <Ionicons name="time-outline" size={18} color="#FF4D6D" />
              <Text style={styles.statLabel}>Duration</Text>
              <Text style={styles.statValue}>{workout.duration}</Text>
            </View>

            <View style={styles.statBox}>
              <Ionicons name="flame-outline" size={18} color="#FF4D6D" />
              <Text style={styles.statLabel}>Calories</Text>
              <Text style={styles.statValue}>{workout.calories}</Text>
            </View>

            <View style={styles.statBox}>
              <Ionicons name="fitness-outline" size={18} color="#FF4D6D" />
              <Text style={styles.statLabel}>Exercises</Text>
              <Text style={styles.statValue}>{workout.exercises ? workout.exercises.length : 4}</Text>
            </View>
          </View>
